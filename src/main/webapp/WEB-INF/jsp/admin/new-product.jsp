                    ...
                    <div class="pcoded-inner-content">
                        <div class="main-body">
                            <div class="page-wrapper">
                                ...
                                <div class="page-body">
                                    <form:form modelAttribute="product" action="${pageContext.request.contextPath}/admin/new-product-submit" method="post"
                                        ...
                                        <span><form:errors path="productName" cssClass="error"/> </span><br>

                                        <h6>Category: </h6>
                                        <div><form:select path="category">
                                            ...
                                            <form:errors path="category" cssClass="error"/></div>
                                        <br>


                                        <form:textarea path="productDescription"/><br>
                                        <span> <form:errors path="productDescription" cssClass="error"/></span>
                                        <br>
